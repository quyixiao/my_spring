...
import javax.servlet2.ServletInputStream;
...
public class ServletRequestWrapper implements javax.servlet2.ServletRequest {
    private javax.servlet2.ServletRequest request;
	...
	*/
    ...
    public ServletRequestWrapper(javax.servlet2.ServletRequest request) {
	if (request == null) {
	...
	*/
	public javax.servlet2.ServletRequest getRequest() {
		return this.request;
	}
