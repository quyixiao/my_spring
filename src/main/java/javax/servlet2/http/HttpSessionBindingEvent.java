...
import javax.servlet2.http.HttpSessionAttributeListener;
import javax.servlet2.http.HttpSessionBindingListener;
import javax.servlet2.http.HttpSessionEvent;
...
public class HttpSessionBindingEvent extends HttpSessionEvent {
    ...
    public HttpSessionBindingEvent(javax.servlet.http.HttpSession session, String name) {
	super(session);
	this.name = name;
    }
    ...
    public HttpSessionBindingEvent(javax.servlet.http.HttpSession session, String name, Object value) {
	super(session);
	this.name = name;
	this.value = value;
    }
