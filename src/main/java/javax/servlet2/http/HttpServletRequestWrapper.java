...
import javax.servlet2.ServletRequestWrapper;
import javax.servlet2.http.Cookie;
import javax.servlet2.http.HttpServletRequest;
import javax.servlet2.http.HttpSession;
...
public class HttpServletRequestWrapper extends ServletRequestWrapper implements javax.servlet2.http.HttpServletRequest {

	/** 
	* Constructs a request object wrapping the given request.
	* @throws IllegalArgumentException if the request is null
	*/
    public HttpServletRequestWrapper(javax.servlet2.http.HttpServletRequest request) {
	    super(request);
    }
    
    private javax.servlet2.http.HttpServletRequest _getHttpServletRequest() {
