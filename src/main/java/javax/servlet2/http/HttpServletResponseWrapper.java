...
package javax.servlet2.http;

import java.io.IOException;

import javax.servlet2.ServletResponseWrapper;
import javax.servlet2.http.Cookie;
 ...
 * @since	v 2.3
 *
 * @see 	javax.servlet2.http.HttpServletResponse
 *
 */

public class HttpServletResponseWrapper extends ServletResponseWrapper implements javax.servlet2.http.HttpServletResponse {
    ...
    */
    public HttpServletResponseWrapper(javax.servlet2.http.HttpServletResponse response) {
	    super(response);
    }
    
    private javax.servlet2.http.HttpServletResponse _getHttpServletResponse() {
