/*
 * $Id: JspUtil.java 797765 2009-07-25 13:20:26Z apetrelli $
 *
...
import org.apache.tiles2.impl.NoSuchContainerException;
import org.apache.tiles2.jsp.taglib.TilesJspException;
...
public final class JspUtil {
     ...
     * @since 2.1.2
     */
    public static org.apache.tiles2.TilesContainer getContainer(JspContext context) {
        return getContainer(context, org.apache.tiles2.access.TilesAccess.CONTAINER_ATTRIBUTE);
    }
     ...
     * @since 2.1.2
     */
    public static org.apache.tiles2.TilesContainer getContainer(JspContext context, String key) {
        if (key == null) {
            key = org.apache.tiles2.access.TilesAccess.CONTAINER_ATTRIBUTE;
        }
        return (org.apache.tiles2.TilesContainer) context.getAttribute(key,
    ...
    public static void setContainer(JspContext context,
        ...
        setContainer(context, container, org.apache.tiles2.access.TilesAccess.CONTAINER_ATTRIBUTE);
    }
     ...
     */
    public static void setContainer(JspContext context,
                                    org.apache.tiles2.TilesContainer container, String key) {
    ...
    public static void setCurrentContainer(JspContext context, String key) {
        org.apache.tiles2.TilesContainer container = getContainer(context, key);
        if (container != null) {
     ...
     * @since 2.1.0
     */
    public static org.apache.tiles2.TilesContainer getCurrentContainer(JspContext context) {
        org.apache.tiles2.TilesContainer container = (TilesContainer) context.getAttribute(
