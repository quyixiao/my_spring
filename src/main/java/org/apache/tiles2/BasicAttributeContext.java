/*
 * $Id: BasicAttributeContext.java 831448 2009-10-30 20:39:52Z apetrelli $
 *
...
public class BasicAttributeContext implements AttributeContext, Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        return CompareUtil.nullSafeEquals(templateAttribute, bac.templateAttribute)
                && CompareUtil.nullSafeEquals(preparer, bac.preparer)
                && CompareUtil.nullSafeEquals(attributes, bac.attributes)
                && CompareUtil.nullSafeEquals(cascadedAttributes, bac.cascadedAttributes);
    }

    /** {@inheritDoc} */
    @Override
    public int hashCode() {
        return CompareUtil.nullSafeHashCode(templateAttribute) + CompareUtil.nullSafeHashCode(preparer)
                + CompareUtil.nullSafeHashCode(attributes)
                + CompareUtil.nullSafeHashCode(cascadedAttributes);
    }
