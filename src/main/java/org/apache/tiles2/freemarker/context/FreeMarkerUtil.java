/*
 * $Id: FreeMarkerUtil.java 797765 2009-07-25 13:20:26Z apetrelli $
 *
...
package org.apache.tiles2.freemarker.context;
...
import org.apache.tiles2.freemarker.io.NullWriter;
...
public final class FreeMarkerUtil {
     ...
     * @since 2.2.0
     */
    public static org.apache.tiles2.TilesContainer getContainer(Environment env, String key) {
        if (key == null) {
            key = TilesAccess.CONTAINER_ATTRIBUTE;
        }
        return (org.apache.tiles2.TilesContainer) getServletContextHashModel(env).getServlet()
    ...
    public static void setCurrentContainer(Environment env, String key) {
        org.apache.tiles2.TilesContainer container = getContainer(env, key);
        if (container != null) {
