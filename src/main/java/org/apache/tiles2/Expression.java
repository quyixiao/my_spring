...
public class Expression {
    ...
    public boolean equals(Object obj) {
        ...
        return CompareUtil.nullSafeEquals(expression, exp.expression)
                && CompareUtil.nullSafeEquals(language, exp.language);
    }

    /** {@inheritDoc} */
    @Override
    public int hashCode() {
        return CompareUtil.nullSafeHashCode(expression) + CompareUtil.nullSafeHashCode(language);
    }
