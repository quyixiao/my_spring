/*
 * $Id: TilesDispatchServlet.java 791161 2009-07-04 18:53:36Z apetrelli $
 *
...
public class TilesDispatchServlet extends HttpServlet {
     ...
     */
    private org.apache.tiles2.web.util.AttributeContextMutator mutator;
    ...
    public void init() throws ServletException {
        ...
        if (temp != null) {
            try {
                mutator = (org.apache.tiles2.web.util.AttributeContextMutator) ClassUtil.instantiate(temp);
            } catch (Exception e) {
