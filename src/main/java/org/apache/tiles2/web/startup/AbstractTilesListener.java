...
public abstract class AbstractTilesListener implements ServletContextListener {
     ...
     * @since 2.1.2
     */
    protected org.apache.tiles2.startup.TilesInitializer initializer;
    ...
    /**
     * Creates a new instance of {@link org.apache.tiles2.startup.TilesInitializer}. Implement it to use a
