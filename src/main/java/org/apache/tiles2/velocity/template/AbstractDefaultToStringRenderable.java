...
import org.apache.tiles2.velocity.TilesVelocityException;
...
public abstract class AbstractDefaultToStringRenderable implements Renderable {
    ...
    public String toString() {
        ...
        try {
            ...
            throw new org.apache.tiles2.velocity.TilesVelocityException("Cannot invoke method when rendering", e);
        } catch (ParseErrorException e) {
            throw new org.apache.tiles2.velocity.TilesVelocityException("Cannot parse when rendering", e);
        } catch (ResourceNotFoundException e) {
            throw new org.apache.tiles2.velocity.TilesVelocityException("Cannot find resource when rendering", e);
        } catch (IOException e) {
