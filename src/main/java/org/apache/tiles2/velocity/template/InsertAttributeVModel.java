/*
 * $Id: InsertAttributeVModel.java 901361 2010-01-20 20:10:27Z apetrelli $
 *
...
public class InsertAttributeVModel implements Executable, BodyExecutable {
     ...
     * The template model.
     */
    private org.apache.tiles2.template.InsertAttributeModel model;
    ...
    public void start(HttpServletRequest request, HttpServletResponse response,
        ...
        model.start(ServletUtil.getComposeStack(request), ServletUtil.getCurrentContainer(request, servletContext),
                ...
                (org.apache.tiles2.Attribute) params.get("value"), velocityContext, request, response);
