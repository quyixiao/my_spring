/*
 * $Id: GetAsStringDirective.java 902403 2010-01-23 13:31:17Z apetrelli $
 *
...
/**
 * Wraps {@link org.apache.tiles2.template.GetAsStringModel} to be used in Velocity. For the list of
 * parameters, see
 * {@link org.apache.tiles2.template.GetAsStringModel#start(java.util.Stack, TilesContainer, boolean,
 * String, String, Object, String, String, String, org.apache.tiles2.Attribute, Object...)}
 * , {@link org.apache.tiles2.template.GetAsStringModel#end(java.util.Stack, TilesContainer, Writer, boolean, Object...)} and
 * {@link org.apache.tiles2.template.GetAsStringModel#execute(TilesContainer, Writer, boolean, String,
 * String, Object, String, String, String, org.apache.tiles2.Attribute, Object...)}.
 *
...
public class GetAsStringDirective extends BlockDirective {
     ...
     * The template model.
     */
    private org.apache.tiles2.template.GetAsStringModel model = new org.apache.tiles2.template.GetAsStringModel(
