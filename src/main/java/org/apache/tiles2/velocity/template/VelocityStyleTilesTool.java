/*
 * $Id: VelocityStyleTilesTool.java 904552 2010-01-29 16:41:26Z apetrelli $
 *
...
public class VelocityStyleTilesTool extends ContextHolder {
     ...
     * @since 2.2.0
     */
    public org.apache.tiles2.Attribute get(String key) {
        org.apache.tiles2.TilesContainer container = ServletUtil.getCurrentContainer(
                getRequest(), getServletContext());
        org.apache.tiles2.AttributeContext attributeContext = container.getAttributeContext(
                getVelocityContext(), getRequest(), getResponse());
        org.apache.tiles2.Attribute attribute = attributeContext.getAttribute(key);
        return attribute;
    }
     ...
     * @since 2.2.0
     */
    public org.apache.tiles2.Attribute createAttribute() {
        return new org.apache.tiles2.Attribute();
    }
     ...
     * @since 2.2.0
     */
    public org.apache.tiles2.Attribute clone(org.apache.tiles2.Attribute attribute) {
        return new org.apache.tiles2.Attribute(attribute);
    }
     ...
     * @since 2.2.0
     */
    public org.apache.tiles2.Attribute createTemplateAttribute(String template) {
        return org.apache.tiles2.Attribute.createTemplateAttribute(template);
    }
    ...
    public Renderable render(final Attribute attribute) {
        return new org.apache.tiles2.velocity.template.AbstractDefaultToStringRenderable(getVelocityContext(),
                null, getResponse(), getRequest()) {

            public boolean render(InternalContextAdapter context, Writer writer)
                    throws IOException {
                org.apache.tiles2.TilesContainer container = ServletUtil.getCurrentContainer(request, getServletContext());
     ...
     * @since 2.2.0
     */
    public org.apache.tiles2.AttributeContext startAttributeContext() {
        org.apache.tiles2.TilesContainer container = ServletUtil.getCurrentContainer(
                getRequest(), getServletContext());
