/*
 * $Id: ELAttributeEvaluator.java 817357 2009-09-21 18:16:20Z apetrelli $
 *
 ...
 *
 * @version $Rev: 817357 $ $Date: 2009-09-21 20:16:20 +0200 (lun, 21 set 2009) $
 * @since 2.2.1
 */
public class ELAttributeEvaluator extends AbstractAttributeEvaluator implements
    ...
    public Object evaluate(String expression, TilesRequestContext request) {
        org.apache.tiles2.el.ELContextImpl context = new ELContextImpl(resolver);
