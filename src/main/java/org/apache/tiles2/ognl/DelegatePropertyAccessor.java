/*
 * $Id: DelegatePropertyAccessor.java 817009 2009-09-20 11:26:26Z apetrelli $
 *
...
/**
 * Uses a {@link org.apache.tiles2.ognl.PropertyAccessorDelegateFactory} to delegate the methods to
...
public class DelegatePropertyAccessor<T> implements PropertyAccessor {
     ...
     * @since 2.2.0
     */
    private org.apache.tiles2.ognl.PropertyAccessorDelegateFactory<T> factory;
