/*
 * $Id: Definition.java 822418 2009-10-06 18:34:05Z apetrelli $
 *
 ...
 *
 * @since Tiles 2.0
 * @version $Rev: 822418 $ $Date: 2009-10-06 20:34:05 +0200 (mar, 06 ott 2009) $
 */
public class Definition extends BasicAttributeContext {
     ...
     * @deprecated Use {@link #Definition(String, org.apache.tiles2.Attribute, Map)}.
     */
    public Definition(String name, String template,
                               Map<String, org.apache.tiles2.Attribute> attributes) {
        this(name, org.apache.tiles2.Attribute.createTemplateAttribute(template), attributes);
    }
     ...
     * @since 2.1.2
     */
    public Definition(String name, org.apache.tiles2.Attribute templateAttribute,
                               Map<String, org.apache.tiles2.Attribute> attributes) {
        super(attributes);
        this.name = name;
    ...
    public String getTemplate() {
        if (templateAttribute == null) {
            templateAttribute = org.apache.tiles2.Attribute.createTemplateAttribute(null);
        }
    ...
    public void setTemplate(String template) {
        if (templateAttribute == null) {
            templateAttribute = org.apache.tiles2.Attribute.createTemplateAttribute(template);
        } else {
     ...
     * @deprecated Use {@link org.apache.tiles2.AttributeContext#getLocalAttributeNames()} and
     * {@link org.apache.tiles2.AttributeContext#getCascadedAttributeNames()}.
     */
    @Deprecated
    public Map<String, org.apache.tiles2.Attribute> getAttributes() {
        return attributes;
    }
     ...
     * @deprecated Use {@link Definition#putAttribute(String, org.apache.tiles2.Attribute)}.
     */
    @Deprecated
    public void addAttribute(org.apache.tiles2.Attribute attribute) {
     ...
     * @deprecated Check if the {@link org.apache.tiles2.AttributeContext#getAttribute(String)}
     * returns null.
     */
    @Deprecated
     ...
     * @deprecated Use {@link org.apache.tiles2.AttributeContext#putAttribute(String, org.apache.tiles2.Attribute)}
     * or {@link org.apache.tiles2.AttributeContext#putAttribute(String, org.apache.tiles2.Attribute, boolean)}.
     */
    @Deprecated
    ...
    public void put(String name, Object content, String role) {
        org.apache.tiles2.Attribute attribute = new org.apache.tiles2.Attribute(content, (Expression) null, role,
                (String) null);
     ...
     * @param role    Determine if content is used by get tag. If user is in role, content is used.
     * @deprecated Use {@link org.apache.tiles2.AttributeContext#putAttribute(String, org.apache.tiles2.Attribute)}
     * or {@link AttributeContext#putAttribute(String, org.apache.tiles2.Attribute, boolean)}.
     */
    @Deprecated
    public void put(String name, Object content,
                    org.apache.tiles2.Attribute.AttributeType type, String role) {
        // Is there a type set ?
        // First check direct attribute, and translate it to a valueType.
        // Then, evaluate valueType, and create requested typed attribute.
        org.apache.tiles2.Attribute attribute = new Attribute(content, role, type);
        putAttribute(name, attribute);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return CompareUtil.nullSafeEquals(name, def.name)
                && CompareUtil.nullSafeEquals(inherit, def.inherit) && super.equals(def);
    }

    /** {@inheritDoc} */
    @Override
    public int hashCode() {
        return CompareUtil.nullSafeHashCode(name) + CompareUtil.nullSafeHashCode(inherit)
                + super.hashCode();
    }
