/*
 * $Id: BaseLocaleUrlDefinitionDAO.java 797540 2009-07-24 15:42:00Z apetrelli $
 *
...
import org.apache.tiles2.definition.RefreshMonitor;
...
public abstract class BaseLocaleUrlDefinitionDAO implements
     ...
     *
     * @deprecated use {@link org.apache.tiles2.definition.DefinitionsFactory#DEFINITIONS_CONFIG} to avoid
     ...
     * @since 2.1.0
     */
    protected org.apache.tiles2.definition.DefinitionsReader reader;
    ...
    /**  {@inheritDoc}*/
    public void setReader(org.apache.tiles2.definition.DefinitionsReader reader) {
        this.reader = reader;
    }
    ...
    public void init(Map<String, String> params) {
        ...
        String readerClassName = params
                .get(org.apache.tiles2.definition.DefinitionsFactory.READER_IMPL_PROPERTY);
    ...
    protected void identifySources(Map<String, String> initParameters) {
        ...
        try {
            ...
            throw new org.apache.tiles2.definition.DefinitionsFactoryException(
     ...
     * parameter {@link org.apache.tiles2.definition.DefinitionsFactory#DEFINITIONS_CONFIG} is available,
